...
class BuddyBot {
    ...
    _welcomeUser(originalMessage) {
        ...
        var welcomeMsg = "Thanks for joining Angular Buddies! Please check out our <http://www.github.com|FAQs and Code of Conduct>. " + "If you're brand new to Angular, post questions to <#" + noobChannel.id + "|noob>, " + "otherwise, post to <#" + helpChannel.id + "|help>. Feel free to message admins like " + "<@" + pocket.id + "|pocket> or <@" + breakingthings.id + "|breakingthings> if any issues come up.";
